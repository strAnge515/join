 ...
 * @returns {Promise<string>} The ID of the newly created document in Firebase.
 */
 ...
 * @returns {Promise<Array>} An array containing all task objects including their Firebase IDs.
 */
 ...
 * @param {string} taskId - The unique Firebase ID of the task to be deleted.
 */
